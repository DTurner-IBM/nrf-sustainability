    ...
    var options = {
            ...
            onReady: {
                ...
                render: function ($container, $newContent) {
                    ...
                    $(document).ready(function () {
                        ...
                        var data3D = pageSettings.data('particle-position');
                        if (data3D === null) {data3D = 1;}
                        setTimeout(()=>{dispatchEvent(new CustomEvent("particlePosition", {"detail":data3D}))},50);
                    
                        var data3DOpacity = pageSettings.data('particle-opacity');
                        if (data3DOpacity === null) {data3DOpacity = 100;}
                        setTimeout(()=>{dispatchEvent(new CustomEvent("particleOpacity", {"detail":data3DOpacity}))},50);
                            ...
                            function onScroll(event){
                                ...
                                $('#sidemenu a').each(function () {
                                    ...
                                    if (refElement.offset().top <= scrollPos +200 && refElement.offset().top + refElement.height() > scrollPos) {
                                        $('#sidemenu ul li a').removeClass("qactive");
                                        currLink.addClass("qactive");
                                    }
                                    else {
                                        currLink.removeClass("qactive");
                                    }
                                });
                            };
                            ...
                            $('a[href^="#"]').on('click', function (e) {
                                ...
                                $(this).find('#sidemenu li a').addClass('qactive');
                        ...
                        /* if ($('.pdf-slides').length > 0) {
                            let pdfHolder = document.querySelector('#pdfviewer').dataset.pdf;
                            ...
                            function renderPage(num) {
                                ...
                                pdfDoc.getPage(num).then(function (page) {
                                  ...
                                  var viewport = page.getViewport({ scale: scaleNew, });
                              ...
                              pdfjsLib.getDocument(pdfHolder).promise.then(function (pdfDoc_) {
                                pdfDoc = pdfDoc_;
                        ...
                        if ($('.list-v2').length > 0) {
                            ...
                            if ($('.list-v2').length > 0) {
                                ...
                                //let $this = $(this),
                                    ...
                                    $this.parent(allProjects).first().addClass('hover');
                                    $(image).addClass('active');
                                    //$this.addClass("hover");
            
                            }

                            $('.listv2-project a').on('click', function (i) {
                                let $this = $(this),
                                    image = $this.parent('.listv2-project').attr('data-image'),
                                    allImages = $('.project-image'),
                                    dataURL = $this.attr('data-urlcontent'),
                                    allProjects = $('.listv2-project');
                
                                allImages.removeClass('active');
                                $(image).addClass('active');
                
                                $('.listv2-wrapper a').addClass('hovered')
                
                                allProjects.removeClass('hover')
                                $this.parent(allProjects).addClass('hover');
                                var exploreBtn = document.getElementById("explore-btn");
                                if (exploreBtn) {
                                    exploreBtn.setAttribute('href', dataURL);
                                    exploreBtn.classList.add("toggle-explore");
                                    setTimeout(() => {exploreBtn.classList.remove("toggle-explore")}, 550);
                                  }
                            })
                        ...
                        if ($('.big-slider').length > 0) {
                            ...
                            $('.example-showcase').addClass('loading')
                        ...
                        if ($('.all-projects').length > 0) {
                            ...
                            $('.project').on('mouseenter', function () {
                                ...
                                if ($(this).hasClass('light')) {
                                    $('.example-showcase').addClass('light-init')
                                }
                            ...
                            $('.project').on('mouseleave', function () {
                                ...
                                $('.example-showcase').removeClass('light-init')
                        ...
                        /* Horizontal */
                        if ($('.ibm-horizontal').length > 0) {

                            $('.ibm-horizontal').prepend('<span class="hor-ov"></span><span class="hor-ov"></span><span class="hor-ov"></span>')

                            $('.line').addClass('line-arange');


                            var horTitle = $('.ibm-horizontal .title');
                            ...
                            $('.ibm-horizontal-images').addClass('swiper-container');
                            $('.ibm-horizontal-images').append('<div class="swiper-wrapper"></div>');
                            ...
                            $('.horizontal-item').each(function (i) {
                                ...
                                if ($(this).find('video').length > 0) {
                                    ...
                                    var horWrapper = $('.ibm-horizontal-images .swiper-wrapper');
                            ...
                            var horImages = new Swiper('.ibm-horizontal-images', {
                                mousewheel: {
                                    invert: false,
                                },
                                slidesPerView: 1,
                            ...
                            $('.ibm-horizontal-titles .swiper-slide').each(function () {
                            ...
                            var horTitles = new Swiper('.ibm-horizontal-titles', {
                                mousewheel: {
                                    invert: false,
                                },
                                slidesPerView: 'auto',
                                ...
                                containerClass: 'ibm-horizontal-titles',
                                pagination: {
                            ...
                            loadingAn.finished.then(function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    $('.ibm-horizontal-titles .title span').each(function (i, element) {
                                    ...
                                    $('.ibm-horizontal-images').addClass('init')
                                ...
                                setTimeout(function () {
                                    ...
                                    $('.ibm-horizontal-titles').addClass('hor-init');
                        ...
                        if ($('.scale-iframe').length > 0) {
                            let thisScale =  $('.iframe-wrapper').width() / $('.scale-iframe').width();
                            if(thisScale < 1){
                                $('.scale-iframe').css('transform', 'scale(' + thisScale+ ')');
                                let holderHeight = $('.hold-iframe').height();
                                $('.hold-iframe').css('height', holderHeight * thisScale);
                            }
                        }
            ...
            onAfter: function ($container, $newContent) {
                ...
                if ($('.big-slider').length > 0) {
                    ...
                    $('.example-showcase').removeClass('loading')
