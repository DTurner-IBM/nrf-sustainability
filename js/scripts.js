(function ($) {
   ...
   // $('.lines').prepend(line);
    ...
    setTimeout(()=>{dispatchEvent(new CustomEvent("particlePosition", {"detail":data3D}))},2000);

    var data3DOpacity = pageSettings.data('particle-opacity');
    if (data3DOpacity === null) {data3DOpacity = 100;}
    setTimeout(()=>{dispatchEvent(new CustomEvent("particleOpacity", {"detail":data3DOpacity}))},2000);
    ...
    $('.menu-toggle').prepend('<div class="icon"></div>')
    ...
    $(window).on('load', function () {
        ...
        var loadingAn = anime({
            ...
            begin: function (anim) {
                $('.ibm-loader').addClass('in');
            },
            complete: function (anim) {

                $('.ibm-loader').addClass('out');
