...
import { Pass, FullScreenQuad } from "../lib/jsm/postprocessing/Pass.js";
...
class UnrealBloomPassAlpha extends Pass {
	...
	constructor( resolution, strength, radius, threshold ) {
		...
		if ( LuminosityHighPassShader === undefined )
			console.error( 'THREE.UnrealBloomPassAlpha relies on LuminosityHighPassShader' );
		...
		if ( CopyShader === undefined ) {
			...
			console.error( 'THREE.UnrealBloomPassAlpha relies on CopyShader' );
